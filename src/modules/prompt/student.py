...
from config.prompt import student_prompt
from utils import *


class StudentPrompt(PromptTemplateBase):
    """
    学生智能体提示词生成
    """
...
if __name__ == '__main__':
    student_id = "S00001"
    student = StudentPrompt(student_id)
    prompt = student.create_prompt()
    print(prompt)
